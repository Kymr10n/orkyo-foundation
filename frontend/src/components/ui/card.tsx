...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    // p-4 on phones for density (UI-GUIDELINES §16); p-6 from md: up. Callers
    // overriding padding must prefix the md: variant too (e.g. "pb-3 md:pb-3"),
    // or md:p-6 wins on desktop.
