...
- **DONE 2026-06-15: assertion library is `AwesomeAssertions` 9.4.0** (OSS fork). The previous assertion library became commercial-paid at v8; Orkyo dependencies must never use commercial licenses. The namespace was renamed to `AwesomeAssertions` across saas + foundation + community test projects.
